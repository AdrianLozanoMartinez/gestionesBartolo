...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-01-2024 a las 22:30:56
...
INSERT INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`, `pass`) VALUES
(1002, 'Murphy', 'Diane', 'x5800', 'dmurphy@classicmodelcars.com', '1', NULL, 'President', 'abc123'),
(1056, 'Pattersonxxxxxxxxxxxxxxx', 'Mary', 'x4611', 'mpatterso@classicmodelcars.com', '1', 1002, 'VP Sales', 'abc123'),
(1076, 'Firrelli', 'Jeff', 'x9273', 'jfirrelli@classicmodelcars.com', '1', 1002, 'VP Marketing', 'abc123'),
(1088, 'Patterson', 'Williamcccccccccccc', 'x4871', 'wpatterson@classicmodelcars.com', '6', 1056, 'Sales Manager (APAC)', 'abc123333'),
(1165, 'Jennings', 'Leslied', 'x3291', 'ljennings@classicmodelcars.com', '1', 1143, 'Sales Rep', 'abc123'),
(1166, 'Thompson', 'Leslie', 'x4065', 'lthompson@classicmodelcars.com', '1', 1143, 'Sales Rep', 'abc123'),
(1188, 'Firrelli', 'Julie', 'x2173', 'jfirrelli@classicmodelcars.com', '2', 1143, 'Sales Rep', 'abc123'),
(1216, 'Patterson', 'Steve', 'x4334', 'spatterson@classicmodelcars.com', '2', 1143, 'Sales Rep', 'abc123'),
(1286, 'Tseng', 'Foon Yue', 'x2248', 'ftseng@classicmodelcars.com', '3', 1143, 'Sales Rep', 'abc123'),
(1323, 'Vanauf', 'George', 'x4102', 'gvanauf@classicmodelcars.com', '3', 1143, 'Sales Rep', 'abc123'),
(1337, 'Bondur', 'Loui', 'x6493', 'lbondur@classicmodelcars.com', '4', 1102, 'Sales Rep', 'abc123'),
(1370, 'Hernandez', 'Gerard', 'x2028', 'ghernande@classicmodelcars.com', '4', 1102, 'Sales Rep', 'abc123'),
(1401, 'Castillo', 'Pamela', 'x2759', 'pcastillo@classicmodelcars.com', '4', 1102, 'Sales Rep', 'abc123'),
(1501, 'Bott', 'Larry', 'x2311', 'lbott@classicmodelcars.com', '7', 1102, 'Sales Rep', 'abc123'),
(1504, 'Jones', 'Barry', 'x102', 'bjones@classicmodelcars.com', '7', 1102, 'Sales Rep', 'abc123'),
(1621, 'Nishi', 'Mami', 'x101', 'mnishi@classicmodelcars.com', '5', 1056, 'Sales Rep', 'abc123'),
(1625, 'Kato', 'Yoshimi', 'x102', 'ykato@classicmodelcars.com', '5', 1621, 'Sales Rep', 'abc123'),
(1702, 'Gerard', 'Martin', 'x2312', 'mgerard@classicmodelcars.com', '4', 1102, 'Sales Rep', 'abc123'),
(1716, 'sdds', 'sdd', 'err', 'ere', '1', 34, 'ererr', 'fefd'),
(1721, 'uju', 'ujujj', 'ujuju', 'juu', '1', 666, 'juju', 'kkjk'),
(1722, 'dcvc', 'cvcv', 'eeer', 'eer', '1', 3434, 'errer', 'ff34'),
(1724, 'xxxxxxxx', 'xxxxxxxx', 'xxxxx', 'xxxxxxxxxx', '1', 23, 'xxxxx', 'wewds'),
(1728, 'Bartolo1', '', '', '', '3', NULL, '', ''),
(1729, 'Bartolo2', '', '', '', '1', NULL, '', ''),
(1730, 'Bartolo3', '', '', '', '4', NULL, '', ''),
(1731, 'Bartolo6', '', '', '', '4', NULL, '', ''),
(1732, 'Bartolo7', '', '', '', '5', NULL, '', '');
...
--
ALTER TABLE `employees`
  MODIFY `employeeNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1733;
